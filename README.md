...
# Further setup
- Make entries for the other files and set the layout as default for outside user sessions (such as a *display manager*) manually (at `/usr/share/X11/xkb/rules/`)
